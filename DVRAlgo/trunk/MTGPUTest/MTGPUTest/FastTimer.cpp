// FastTimer.cpp: implementation of the FastTimer class.
//
//////////////////////////////////////////////////////////////////////
#include "stdafx.h"
//#include "csclient.h"
...
__int64 g_ClockSpeed;	// Clocks/sec
...
static __int64 CalculateClockSpeed()
{
#ifdef _WIN32
...
const CPUInformation& GetCPUInformation()
{
	...
	pi.m_nPhysicalProcessors = BYTE(si.dwNumberOfProcessors / pi.m_nLogicalProcessors);
	pi.m_nLogicalProcessors  = BYTE(pi.m_nLogicalProcessors * pi.m_nPhysicalProcessors);
